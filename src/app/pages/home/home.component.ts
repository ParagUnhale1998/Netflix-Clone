...
export class HomeComponent implements OnInit {
    ...
    forkJoin(this.MoviesApi)
      .pipe(
        map(([popularMovies, topRatedMovies, upcomingMovies,nowPlayingTV]) => {
          return { popularMovies, topRatedMovies, upcomingMovies ,nowPlayingTV};
        })
      )
      .subscribe((res: any) => {
  ...
  fetchTvShowsData() {
    forkJoin(this.TVShowsApi)
      .pipe(
        map(([trendingTvShows, topRatedTvShows, comedyTvShows,nowPlayingTV]) => {
          return { trendingTvShows, topRatedTvShows, comedyTvShows ,nowPlayingTV};
        })
      )
      .subscribe((res: any) => {
...
/* old clean code without storing the data
  MoviesApi = [
    this.apiService.getPopularMovies(),
    this.apiService.getTopRatedMovies(),
    this.apiService.getUpcomingMovies(),
